...
# Print Logo
ascii_banner = pyfiglet.figlet_format("EXIF Data")
print(ascii_banner)
            ...
            for tag, value in image._getexif().items():
                ...
                if tag_name == "GPSInfo":
                    for key, val in value.items():
                        ...
                        # We add Latitude data to the gps_coord dictionary.
                        if GPSTAGS.get(key) == "GPSLatitude":
                            gps_coords["lat"] = val
                        # We add Longitude data to the gps_coord dictionary.
                        elif GPSTAGS.get(key) == "GPSLongitude":
                            gps_coords["lon"] = val
                        # We add Latitude reference data to the gps_coord dictionary.
                        elif GPSTAGS.get(key) == "GPSLatitudeRef":
                            gps_coords["lat_ref"] = val
                        # We add Longitude reference data to the gps_coord dictionary.
